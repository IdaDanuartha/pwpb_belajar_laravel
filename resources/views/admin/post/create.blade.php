            ...
            <form action="/admin/posts" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                        name="title" value="{{ old('title') }}" placeholder="Masukkan judul postingan">
                    @error('title')
                ...
                <div class="form-group mb-4">
                    ...
                    <label for="thumbnail" class="my-4">
                        <img id="img-preview" src="{{ asset('assets/img/nopreview.png') }}" width="250" alt="">
                    </label>
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea class="form-control @error('content') is-invalid @enderror" id="" name="content"
                        placeholder="Tulis konten disini" rows="10">{{ old('content') }}</textarea>
                    @error('content')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
